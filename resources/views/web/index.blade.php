...
<body>
<!-- banner -->
<div class="jumbotron jumbotron-fluid" id="banner" style="background-image: url('{{asset('web/img/banner-bk.jpg')}}');">
...
<div class="container my-5 py-2">
    ...
    <div class="row">
        <div data-aos="fade-up" data-aos-delay="0" data-aos-duration="1000" data-aos-once="true"
            ...
            <img src="{{ asset('web/img/smart-protect-1.jpg') }}" alt="Anti-spam" class="mx-auto">
            <h4>Anti-spam</h4>
        ...
        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000" data-aos-once="true"
             class="col-md-4 text-center">
            <img src="{{ asset('web/img/smart-protect-2.jpg') }}" alt="Phishing Detect" class="mx-auto">
        ...
        <div data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000" data-aos-once="true"
             class="col-md-4 text-center">
            <img src="{{ asset('web/img/smart-protect-3.jpg') }}" alt="Smart Scan" class="mx-auto">
            <h4>Smart Scan</h4>
    ...
    <div class="container my-5">
        <div class="row justify-content-between text-center text-md-left">
            ...
            <div data-aos="fade-left" data-aos-duration="1000" data-aos-once="true" class="col-md-6 align-self-center">
                <img src="{{ asset('web/img/feature-1.png') }}" alt="Take a look inside" class="mx-auto d-block">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row justify-content-between text-center text-md-left">
            ...
            <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="true"
                ...
                <img src="{{ asset('web/img/feature-2.png') }}" alt="Safe and reliable" class="mx-auto d-block">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-md-2 py-2 align-self-center">
                <img src="{{ asset('web/img/client-1.png') }}" class="mx-auto d-block">
            </div>
            <div class="col-sm-4 col-md-2 py-2 align-self-center">
                <img src="{{ asset('web/img/client-2.png') }}" class="mx-auto d-block">
            </div>
            <div class="col-sm-4 col-md-2 py-2 align-self-center">
                <img src="{{ asset('web/img/client-3.png') }}" class="mx-auto d-block">
            </div>
            <div class="col-sm-4 col-md-2 py-2 align-self-center">
                <img src="{{ asset('web/img/client-4.png') }}" class="mx-auto d-block">
            </div>
            <div class="col-sm-4 col-md-2 py-2 align-self-center">
                <img src="{{ asset('web/img/client-5.png') }}" class="mx-auto d-block">
            </div>
            <div class="col-sm-4 col-md-2 py-2 align-self-center">
                <img src="{{ asset('web/img/client-6.png') }}" class="mx-auto d-block">
            </div>
        </div>
    </div>
</div>
<!-- contact -->
<div class="jumbotron jumbotron-fluid" id="contact" style="background-image: url({{ asset('web/img/contact-bk.jpg') }});">
    <div class="container my-5">
        <div class="row justify-content-between">
            ...
            <div class="col-md-6">
                <button type="submit" class="btn font-weight-bold atlas-cta atlas-cta-wide cta-green my-3">Submit
                </button>
            </div>
        </div>
    </div>
